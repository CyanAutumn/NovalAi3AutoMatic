...
namespace AutoNai3Tools
{
    public partial class Form1 : Form
    {
        ...
        private Nai3Body GetNai3Body(int runNum)
        {
            ...
            foreach (DataGridViewRow row in dgvVibe.Rows)
            {
                ...
                string base64img = ConvertImageToBase64(picPath.ToString());
                if(base64img == null)
                {
            ...
            Nai3Body nai3Body = new Nai3Body(input:Prompt.GetPrompt(txtPrompt.Text,this, runNum),parameters: parmeters);
            return nai3Body;
        }

        Nai3Body tempNai3Body = null;
        ...
        private void TimerElapsed(object sender, ElapsedEventArgs e)
        {
            ...
            for (int i = 0; i < max_num; i++)
            {
                ...
                PrintLog("开始发送生图请求");
                string msg = novalAi.SendGenerateRequests(token, output_path, tempNai3Body, chkSavePromptToTxt.Checked,chkSavePromptToTxtNoArtist.Checked , Prompt.PrevArtistFixed,Prompt.PrevArtistRandom,this);
                PrintLog(msg);
                Random random = new Random();
        ...
        private void picVibeView_Click(object sender, EventArgs e)
        {
            ...
            if (path != null)
            {
                ...
                using (FileStream fs = new FileStream(vibe_current_pic_path, FileMode.Open, FileAccess.Read))
                {
        ...
        {
            if (vibe_current_pic_path != null)
            {
                dgvVibe.Rows.Add(vibe_current_pic_path, numVibeIE.Value, numVibeRS.Value);
                if (picVibeView.Image != null)
                {
                    picVibeView.Image.Dispose();
                    picVibeView.Image = null; // 确保引用被清空
                }
                vibe_current_pic_path = null;
            }
            else
            {
        ...
        private void dgvSnippet_SelectionChanged(object sender, EventArgs e)
        {
            ...
            if (dgvVibe.CurrentRow != null)
            {
                ...
                vibe_current_pic_path = selectedRow.Cells["Column1"].Value.ToString();
        ...
        private void btnVibeEdit_Click(object sender, EventArgs e)
        {
            ...
            {
                DataGridViewRow selectedRow = dgvVibe.CurrentRow;
                selectedRow.Cells["Column1"].Value = vibe_current_pic_path;
